...
IMPORTANT: configuration must be loaded before requiring cafe/steps or this will not work!!
********************************************************************
=end

require 'cafe'
Cafe.configure( {:support_directory => File.dirname(__FILE__)})
require 'cafe/config/environment'
