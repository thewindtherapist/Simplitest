...
$outputFile = File.open("../output/PHC-Database Lookup #{Time.now.strftime("%Y%m%d")}.txt", 'w')
...
sqlHash=getSQL("PHC-Database lookup",databasename)

$outputFile.write "PHC-Database lookup \n\n"
